...
interface ConnectorLinesProps {
  ...
  dockedLineRef?: React.Ref<SVGLineElement>
}

export const ConnectorLines = forwardRef<SVGSVGElement, ConnectorLinesProps>((props, ref) => {
  const { menuLineRef, scanLineRef, stationLineRef, dockedLineRef } = props
  ...
  return (
    <SvgLayer ref={ref} role="img" aria-label="Menu connector line">
      ...
      <line ref={dockedLineRef} stroke="#ffffff" strokeWidth="1" opacity="0" strokeDasharray="6 4" />
    </SvgLayer>
  )
})
