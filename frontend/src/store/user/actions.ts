...
export type ActionTypes =
  ...
  | { type: 'LOAD_USER_FAILURE'; error: unknown }
  | { type: 'UPDATE_CREDITS_REQUEST' }
  | { type: 'UPDATE_CREDITS_SUCCESS'; credits: number }
  | { type: 'UPDATE_CREDITS_FAILURE'; error: unknown }
...
export const loadUserFailure = (error: unknown): ActionTypes => ({
...
export const updateCreditsFailure = (error: unknown): ActionTypes => ({
