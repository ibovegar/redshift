...
export const loadUpgrades =
  (spacecraftId: string) => async (dispatch: Dispatch) => {
...
export const detachUpgrade =
  (upgrade: Upgrade) => async (dispatch: Dispatch) => {
...
export const attachUpgrade =
  (spacecraft: Spacecraft, upgrade: Upgrade) => async (dispatch: Dispatch) => {
    const newUpgrade = { ...upgrade };
