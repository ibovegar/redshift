...
export type ActionTypes =
  ...
  | { type: 'LOAD_ALL_SPACECRAFTS_FAILURE'; error: unknown }
...
export const loadAllspacecraftsSuccess = (spacecrafts: Spacecraft[]): ActionTypes => ({
  type: 'LOAD_ALL_SPACECRAFTS_SUCCESS',
  spacecrafts
})

export const loadAllspacecraftsFailure = (error: unknown): ActionTypes => ({
