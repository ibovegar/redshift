...
export type ActionTypes =
  ...
  | { type: 'LOAD_MISSIONS_FAILURE'; error: unknown }
  | { type: 'COMPLETE_MISSION_REQUEST' }
  | { type: 'COMPLETE_MISSION_SUCCESS'; mission: Mission }
  | { type: 'COMPLETE_MISSION_FAILURE'; error: unknown }
...
export const loadMissionsFailure = (error: unknown): ActionTypes => ({
...
export const completeMissionFailure = (error: unknown): ActionTypes => ({
